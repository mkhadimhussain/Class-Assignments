...
const slicedNums: number[] = numbers.slice(1,4);
console.log(slicedNums); // output: [ 2, 3, 4 ]

//------------------------------------------------------------------------------------------

// concat() => Combines two or more arrays and returns a new array.
const numbers1: number[] = [8,9];
const allNum: number[] = numbers.concat(numbers1);
console.log(allNum);  // output: [ 1, 6, 4, 5, 8, 9 ]

// Concatinating three arrays
const numbers2: number[] = [10,11];
const allNum1: number[] = numbers.concat(numbers1,numbers2);
console.log(allNum1);  // output: [ 1, 6, 4, 5, 8, 9, 10, 11 ]

//------------------------------------------------------------------------------------------

// filter() => Creates a new array with elements that pass a test.
const evenNumbes: number[] = numbers.filter(numbers => numbers % 2 === 0);
...
const allEven: boolean = numbers.every(numbers => numbers % 2 === 0);
console.log(allEven);  // output: false

//------------------------------------------------------------------------------------------

// some() => Checks if at least one element in the array satisfies a condition, if yes then return true else false.
const hasEvenNumber: boolean = numbers.some(numbers => numbers % 2 === 0);
...
numbers.forEach(numbers => console.log(`Num ${numbers}`));
// output:
// Num 1
// Num 6
// Num 4
...
const index2: number = numbers.indexOf(4);
...
const index3: number = numbers.indexOf(7);
...
const repeatedNumArray:number[] = [1,3,4,5,2,3];
const lastIndex2: number = repeatedNumArray.lastIndexOf(3);
console.log(lastIndex2);  // output: 5

// Trying another element which is not present in the array
const lastindex3: number = repeatedNumArray.lastIndexOf(6);
...
const reverseSum: number = numbers.reduceRight((acc, curr) => acc + curr, 0);
