...
function firstAsynchronous(callback: (error: any, result: any) => void) {
    setTimeout(() => {
...
function secondAsynchronous(callback: (error: any, result: any) => void) {
    setTimeout(() => {
...
function thirdAsynchronous(callback: (error: any, result: any) => void) {
    setTimeout(() => {
