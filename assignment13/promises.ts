...
const randomOutcomePromise = new Promise<string>((resolve, reject) => {
...
const delayedPromise1 = new Promise<string>((resolve, reject) => {
    setTimeout(()=> {
        resolve("Promise resolved after 2 seconds");
    }, 2000);
});
...
const firstPromise = new Promise<number>((resolve, reject) => {
    setTimeout(() => {
        resolve(10);
    }, 1000);
});
...
const firstPromise1 = new Promise<number>((resolve, reject) => {
    setTimeout(() => {
        resolve(10);
    }, 1000);
});
...
const promise1 = new Promise<number>((resolve) => setTimeout(() => resolve(1), 1000));
const promise2 = new Promise<number>((resolve) => setTimeout(() => resolve(2), 2000));
const promise3 = new Promise<number>((resolve) => setTimeout(() => resolve(3), 3000));
