...
//This is the Assignment of Class 08

//Question: Read and understand the previous all slides.

// Variables 
// Allowed: letters, digits, _ , $
// Not Allowed: start with digit (Let 123 = 432) and not be reserved word like (Let, if,...)

import { multiplication } from "./module.js";

// - Let Variables (changeble/reassigned)
let string: string = "Hello World";
let number: number = 247;
let boolean: boolean = true;

// - Constant Variables (Unchangeble/not reassigned)
const constString: string = "Constant String";
const constNumber: number = 3.14

//-----------------------------------------------------------------------------------

// Case Sensitive
// Common Naming Conventions in TypeScript
let camelCase: string = "camelCase";
let snake_case: string = "snake_case";
let PascalCase: string = "PascalCase";

//-----------------------------------------------------------------------------------

// Strong Typing
let a: number = 45;  // now we can not assign 'a' variable a value of type string, boolean etc
...
let aa:bigint = 2n ** 6n;      // n shows the the number is BigInt
let bb:bigint = aa * 2n;
...
let favNum: number = 24;
console.log(typeof favNum); // Output: number

//-----------------------------------------------------------------------------------

// Concatenation
let name1: string = "Khadim";
let name2: string = "Hussain";
console.log(name1 + " " + name2);  // Output: Khadim Hussain

// Another Example
let myName: string = "Khadim";
let age: number = 23;
...
function marksheet(math: number, eng: number, urdu: number, pst: number, comp: number): string {
    const total: number = 500;
    const obtained: number = math + eng + urdu + pst + comp;
...
let multiplyNum = function multiplication(num1: number, num2: number): number {
    return num1 * num2;
}
